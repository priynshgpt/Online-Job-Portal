...
$sql = "INSERT INTO application( jobid, name, emailid, mobno, asg_file, asg_file_size, asg_file_type, skills, experience, ug_education, pg_education, location_city, prev_employer) VALUES ('$id','$name','$email','$mobile','$subfile', '$subfile_size', '$subfile_type','$skills', $experience, '$ug', '$pg','$location','$prev_employer')";
